...
HEADINGS = [
    ...
    ("commit-sky", "COMMIT ACTIVITY",
     "A STAR CHART OF EVERY DAY WORKED · LIVE FROM THE GITHUB API", CRIMSON),
    ("tech-arsenal", "TECH ARSENAL",
     "LANGUAGES · FRAMEWORKS · INFRASTRUCTURE", BROWN),
    ("server-load", "A SERVER UNDER LOAD",
     "INSIDE THE SERVER AND THE DATABASE WHEN THE REQUESTS PILE UP", AEGEAN),
